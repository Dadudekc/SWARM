"""
Tests for phones module.
"""

import pytest
from unittest.mock import MagicMock, patch
from dreamos\core\messaging\phones import __init__, __init__, send_message, _monitor_response, _save_response, broadcast_message, _get_all_agents
