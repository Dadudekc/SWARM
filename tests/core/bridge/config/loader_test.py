...
"""
Tests for bridge config loader.
"""
...
def test_bridge_config_loader(base_config, mode_config, agent_config):
    """Test BridgeConfigLoader."""
    loader = BridgeConfigLoader(base_config, BridgeMode.TEST)
    ...
    # Test agent config
    config = loader.load_config("test_agent")
...
def test_save_agent_config(test_config_dir, base_config):
    """Test save_agent_config function."""
    config = {
        "bridge": {
            "api_key": "new_key"
        }
