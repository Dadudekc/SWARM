...
cell_phone_stub = types.ModuleType("dreamos.core.cell_phone")
cell_phone_stub.CaptainPhone = object
sys.modules.setdefault("dreamos.core.cell_phone", cell_phone_stub)
