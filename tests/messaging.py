...
from dreamos.core.messaging.response_collector import ResponseCollector, collect_response
...
def persistent_queue():
    ...
    with TemporaryDirectory() as tmpdir:
        queue = PersistentQueue(queue_dir=str(tmpdir))
...
def test_message_creation():
    ...
    assert message.from_agent == "test_user"
...
def test_message_serialization():
    ...
    assert data["from_agent"] == original.from_agent
