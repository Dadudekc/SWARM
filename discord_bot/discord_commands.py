...
class AgentCommands(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot):
        ...
        self.message_processor = None  # Will be initialized in setup_hook
        self.cell_phone = None  # Will be initialized in setup_hook
    ...
    async def cog_load(self):
        ...
        try:
            ...
            await self.cell_phone.start()
        except Exception as e:
            self.log_manager.error(
                platform="discord",
                status="error",
                message=f"Failed to initialize AgentCommands cog: {str(e)}",
                tags=["startup", "error"]
            )
            raise
    ...
    def cog_unload(self):
        ...
        try:
            ...
            self.log_manager.error(
                platform="discord",
                status="error",
                message=f"Error during cog unload: {str(e)}",
                tags=["shutdown", "error"]
            )
