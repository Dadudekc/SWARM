...
class CoordinateCalibrator:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        """
        self.config_path = config_path or str(Path(__file__).parent / "coordinates.json")
    ...
    def calibrate_agent(self, agent_id: str, 
                       initial_spot: Tuple[int, int],
                       input_box: Tuple[int, int],
                       copy_button: Tuple[int, int],
                       response_region: Optional[Dict[str, Dict[str, int]]] = None) -> None:
